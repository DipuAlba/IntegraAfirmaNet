...
namespace IntegraAfirmaNet.Soap.Assertions
{
    class TsaPolicyAssertions
    {
        ...
        public class X509SecurityTokenSoapAssertion : PolicyAssertion
        {
            ...
            {
                SignatureFramework.Tools.ExternalX509TokenProvider tokenProvider = new SignatureFramework.Tools.ExternalX509TokenProvider(keystorePath, keystorePassword);
        ...
        internal class SignedSoapFilter : SoapFilter
        {
            ...
            public SignedSoapFilter(TsaPolicyAssertions.X509SecurityTokenSoapAssertion parent)
            {
                parentAssertion = parent;
            ...
            private SoapFilterResult Sign(SoapEnvelope envelope)
            {
               ...
               */
                ...
                SignatureFramework.SignedXmlTsa signature = new SignatureFramework.SignedXmlTsa(envelope);
                ...
                bsBody.Uri = "#" + bodyId;
                bsBody.AddTransform(new IntegraAfirmaNet.SignatureFramework.XmlDsigC14NTransform());
